...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileClosure = function(o) {
      ...
      if (func.isAsync || ((ref4 = func.base) != null ? ref4.isAsync : void 0)) {
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    function Code(params, body, tag) {
      ...
      this.isAsync = !!this.body.contains(function(node) {
        return node instanceof Op && node.operator === 'await';
      });
    }
  ...
  exports.Op = Op = (function(superClass1) {
    ...
    Op.prototype.isAwait = function() {
      var ref3;
      return (ref3 = this.operator) === 'await' || ref3 === 'await*';
    };
    ...
    Op.prototype.compileYield = function(o) {
      ...
      if (o.scope.parent == null) {
        this.error('yield expression can only be used within a generator function');
      }
      if (o.scope.method.startedAsync != null) {
        this.error('yield cannot be used in an async function');
      }
    ...
    Op.prototype.compileAwait = function(o) {
      ...
      op = this.operator;
      if (o.scope.parent == null) {
        this.error('await expression can only be used within an async function');
      }
      if (o.scope.method.startedGenerator != null) {
        this.error('await cannot be used in a generator function');
      }
